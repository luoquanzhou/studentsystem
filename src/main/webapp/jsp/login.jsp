...
<meta charset="UTF-8">
<title>登录</title>
<link rel="stylesheet" href="<%=request.getContextPath() %>/login/login_list.css"/>
	...
	<div class="data">
		...
		<ul class="logintext">
			...
			<li>
				...
				<p class="account_hint">没有帐号？<a href="/TeachingSystem/register/register.html"class="account_a1">快速注册</a></p>
