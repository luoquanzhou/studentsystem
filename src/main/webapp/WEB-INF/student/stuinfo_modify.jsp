...
<ul id="ulStudMsgHeadTab">
    <li><a class="tab1" onclick="" href="stulist.do">我的信息</a> </li>
    <li><a class="tab2" onclick="" href="stuload.do">修改信息</a> </li>
</ul>
...
<div class="cztable">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            ...
            <td colspan="5">${stu.stuid}<input type="hidden" name="stuid" value="${stu.stuid}"/>&nbsp;</td>
        </tr>
        <tr>
            <td width="91" align="right">姓名：</td>
            <td colspan="5"><input name="stuname" value="${stu.stuname }"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">性别：</td>
            <td colspan="5"><input name="stusex" value="${stu.stusex }"/>&nbsp;</td>
        </tr>
       
        <tr>
            <td align="right">年龄：</td>
            <td colspan="5"><input name="stuage" value="${stu.stuage }"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">班级：</td>
            <td colspan="5"><input name="stuclass" value="${stu.stuclass}"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">专业：</td>
            <td colspan="5"><input name="stuprocour" value="${stu.stuprocour }"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">电话：</td>
            <td colspan="5"><input name="stutel" value="${stu.stutel }"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">QQ：</td>
            <td colspan="5"><input name="stuqq" value="${stu.stuqq }"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">邮箱：</td>
            <td colspan="5"><input name="stuemail" value="${stu.stuemail }"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">地址：</td>
            <td colspan="5"><input name="stuadd" value="${stu.stuadd }"/>&nbsp;</td>
        </tr>
    </tbody></table>
